 ...
 <?php
	...
	$message .= 'O usuário <b>'.$tUsuarioEmail.'</b> da plataforma <b>Copel+</b> está lhe convidando para participar de seu projeto <b>'.$tProjetoAtual.'</b> como Participante. <br><br> Click no link abaixo para ser redirecionado a plataforma e se cadastrar.';
	$message .= '</td>';
	$message .= '</tr>';
	$message .= '</table>';
